  ...
  return (
        <div className="projects-container">
            ...
            <div className="ysbrydgamespage">
                ...
                <p>This page was created taken direct inspiration on the page from videogame publisher <a target="_blank" href="https://www.ysbryd.net">Ysbryd Games</a> in
                an attempt to recreate the page 1:1.
                Developed in React.</p>
                <img src={ysbrydimg} alt="ScreenShot from project page" />
                <a target="_blank" href="https://github.com/andresdlRoca/Proyecto1-STW-UVG">Github Repo</a>
                <br/>
                <a target="_blank" href="http://stw-uvg-22.site:4010">Working page</a>
            </div>
            <div className="uvgentepage">
                ...
                <a target="_blank" href="https://github.com/andresdlRoca/prototipos_ingenieria_software-UVG">Github Repo</a>
            </div>
            <div className="metaverseproject">
                ...
                <a target="_blank" href="https://www.youtube.com/watch?v=oalR09XIHv4">Demo Video</a>
                <br/>
                <a target="_blank" href="https://github.com/andresdlRoca/HCI_Metaverse">Github Repo</a>
                <br/>
            </div>
        </div>
